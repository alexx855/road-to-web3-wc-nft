...
// $downloads = apply_filters('woocommerce_order_get_downloadable_items', $downloads, $order);
...
<section class="woocommerce-order-downloads">
	<?php if (isset($show_title)) : ?>
		<h2 class="woocommerce-order-downloads__title"><?php esc_html_e('NFTs', 'hackathon-wc-nft'); ?></h2>
		<div id="wallet">
			<p><?php esc_html_e('Connected Adress', 'hackathon-wc-nft'); ?>: <span id="wallet-adress"><?php echo $user_address; ?></span></p>
			<!-- <p><?php esc_html_e('NFTs', 'hackathon-wc-nft'); ?>: <span id="wallet-nfts-count"><?php echo count($downloads); ?></span></p> -->
		</div>
